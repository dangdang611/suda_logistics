...
public class SendUtil {
    ...
    private static final String ACCOUNT_SID = "174794aa8aed3cfb99433f9447991c6e";
    private static final String AUTH_TOKEN = "55d8f8d32180cae1f6c9cf24f0e5fada";

    // 根据相应的手机号发送验证码
    public static String sendCode(String phone , String code) {
        String timestamp = getTimestamp();
        String sig = getMD5(ACCOUNT_SID, AUTH_TOKEN, timestamp);
//        String tamp = "【水岸祐邻】亲爱的顾客，您好，您的验证码为：" + code + "，请尽快登录，请勿将密码泄露于他人，若非本人操作，请忽略此短信，祝您生活愉快~~";
        String tamp = "【水岸祐邻】亲爱的顾客，您好，您的验证码为：" + code + "，本条验证码有效期为3分钟";
